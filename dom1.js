...
// document.querySelectorAll(".divs")[0].style.margin ="4px"
...
let selectdiv=document.querySelectorAll(".divs")
// let array = [Fourth,Fifth,Sixth]
console.log(selectdiv)
for(let i = 0; i<selectdiv.length; i++){
  selectdiv[i].style.border = "2px solid black"
//   selectdiv[i].style.margin ="4px"
//   for(let j = 0; j<array.length; j++){
//     selectdiv[i].innerText=="array[j]"
  }
